  ...
  render() {
    ...
    return html`
      <div class="budget">
        ...
        ${renderProgressBar({
          percent: progressPercent(this.budget.spent, this.budget.limit),
          variant: progressVariant(
            progressPercent(this.budget.spent, this.budget.limit),
          ),
          label: this.category?.name ?? this.budget.categoryId,
        })}
        <div class="meta">
