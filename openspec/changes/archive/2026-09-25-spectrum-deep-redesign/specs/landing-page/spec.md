...
La landing page SHALL usar los componentes base y las primitivas de Spectrum (`finap-button`, `sp-card`, `sp-link`, `sp-badge`, tipografía y tokens `--spectrum-*`) en lugar de estilos propios duplicados.
